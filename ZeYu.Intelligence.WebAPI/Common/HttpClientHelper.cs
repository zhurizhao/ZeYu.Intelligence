...
namespace ZeYu.Intelligence.WebAPI.Common
{
    public class HttpClientHelper
    {
        ...
        public static string Request(string url, string postData, System.Text.Encoding encode=null)
        {
            ...
            else
            {
                ...
                HttpContent content = new StringContent(postData, encode, "application/json");
