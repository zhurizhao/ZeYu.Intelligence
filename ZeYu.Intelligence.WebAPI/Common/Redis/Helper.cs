...
namespace ZeYu.Intelligence.WebAPI.Common.Redis
{
    public class Helper
    {
        /// <summary>
        /// 获取 Redis 连接对象
        /// https://stackoverflow.com/questions/46047718/stackexchange-redis-strongname-is-refrenced-but-not-included-as-package
        /// </summary>
        /// <returns></returns>
